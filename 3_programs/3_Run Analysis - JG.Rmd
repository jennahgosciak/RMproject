...
```
```{r}
results <- map_dfr(c(log_outcomes, pct_outcomes), ~run_model_outcome(., models=models, print=FALSE))
results
...
placebo_results <- map_dfr(c(log_outcomes, pct_outcomes), ~run_model_outcome(., models=models), data = placebo_df,
                                                    print=FALSE))
placebo_results
