...
generate_parallel_trends_plot <- function(df, type, outcome_type) {
  if (type == "log") {
  ...
  ggsave(paste0("../2_output/", outcome_type, "_", type, "_parallel_trends.png"),
         height = 15)
}
...
# generate_parallel_trends_plot(merged_oz, "log", "rac")
# generate_parallel_trends_plot(merged_oz, "log", "wac")

generate_parallel_trends_plot(topcommutezones, "pct", "rac")
generate_parallel_trends_plot(topcommutezones, "pct", "wac")
generate_parallel_trends_plot(topcommutezones, "pct", "od")
```
